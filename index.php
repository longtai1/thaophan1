...
<head>
    ...
    <!-- Page title -->
    <title>Vũ Tiến Anh | Bot Cảm Xúc Chất Nhất Việt Nam</title>
                    ...
                    <div class="col-lg-12">
                        <div class="view-header">
                            <div class="pull-right text-right" style="line-height: 14px">
                                <small>VuTienAnh.Pro<br>Dashboard<br> <span class="c-white">v.3.0</span></small>
                            </div>
...
<?php if(!$_SESSION[id])
{
    ?>
                    ...
                    <div class="panel panel-filled">
						...
						<p> Nếu Bạn Sử Dụng <code> VuTienAnh.Pro</code> Trên Điện Thoại Và Không Lấy Được Cookie  ? <p>
